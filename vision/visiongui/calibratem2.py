...
class dreadbotVisionCalibrateUI(App):
    ...
    def idle(self):
        ...
        if not(hsvValuesRead):
            ...
            print("hsvValuesRead=%s" % hsvValuesRead)
    ...
    def loadImage(self, imagefile):
        ...
        self.imgLabel.set_text( "Captured (click to toggle)" )
        self.getImage()
        pass
    ...
    def on_click_imgLabel(self, widget):
        newtext = LABEL_ANNOTATED
        if "Annotation" in self.imgLabel.get_text() :
            newtext = LABEL_CAPTURED 
        self.imgLabel.set_text( newtext )
        self.setImageFile()
        self.getImage()
    ...
    def setImageFile(self):
        txt = self.imgLabel.get_text()
        if  "Annotation" in txt :
            mtime = os.path.getmtime( os.path.join( tmpimagedir, "currentImage", "annotated.jpg") ) 
            self.imgfile = '/res/annotated.jpg'
            self.imgurl = '%s?foo=%s' % (self.imgfile, mtime )
        else:
            self.imgfile = '/res/calibrationImage.jpg'
            self.imgurl = '%s' % (self.imgfile )
    ...
    def getImage(self):
        ...
        if True:
            ...
            oldimgfile = self.imgfile
            self.setImageFile()

            #imgurl = self.imgurl if hasattr(self, 'imgurl') else ""
            imgfile = self.imgfile if hasattr(self, 'imgfile' ) else "/dev/null"
            self.imgurl = imgurl = '%s?foo=%s' % (imgfile, self.last_update )

            # print( "imgfile=%s" % imgfile )

            if "annotated" in imgfile or ( oldimgfile and oldimgfile != imgfile ) :
            
                image1 = Image( imgfile)
                image1.attributes['src'] = imgurl
                image1.attributes['editor_newclass'] = "False"
                image1.attributes['editor_baseclass'] = "Image"
                image1.attributes['editor_constructor'] = "(imgfile)"
                image1.attributes['class'] = "Image"
                image1.attributes['editor_tag_type'] = "widget"
                image1.attributes['editor_varname'] = "image1"
                image1.style['top'] = "70px"
                ...
                image1.style['left'] = "20px"
                self.image1 = image1
                self.mainwin.append(image1,'image1')
    ...
    def construct_ui(self):
        ...
        self.image1 = image1 = Image('/res/calibrationImage.jpg')
        ...
        self.imgLabel = imgLabel = Label(LABEL_CAPTURED)
        imgLabel.attributes['editor_newclass'] = "False"
        imgLabel.attributes['editor_baseclass'] = "Label"
        imgLabel.attributes['editor_constructor'] = "('Calibrate')"
        imgLabel.attributes['class'] = "Label"
        imgLabel.attributes['editor_tag_type'] = "widget"
        imgLabel.attributes['editor_varname'] = "imgLabel"
        imgLabel.style['right'] = "385px"
        imgLabel.style['top'] = "45px"
        imgLabel.style['font-size'] = "14px"
        imgLabel.style['height'] = "24px"
        imgLabel.style['width'] = "238px"
        imgLabel.style['position'] = "absolute"
        imgLabel.style['overflow'] = "visible"
        imgLabel.style['font-weight'] = "bold"
        imgLabel.style['margin'] = "0px"
        imgLabel.style['display'] = "block"
        imgLabel.style['left'] = "95px"
        container1.append(imgLabel,'imgLabel')
        hue2Label = Label('Hue :')
        ...
        self.mainwin = self.container1 = container1
        self.image1 = image1
        ...
        self.imgLabel.set_on_click_listener(self.on_click_imgLabel)        
